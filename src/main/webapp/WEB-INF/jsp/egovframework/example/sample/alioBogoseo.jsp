...
<head>
	...
	<c:url var="alioBogoseoURL" value="alioBogoseo.do"></c:url>
    ...
    /* 글 수정 화면 function */
    function fn_egov_select(bogoseo_id) {
    	//alert("bogoseo_id =="+ bogoseo_id)
    	document.listForm.bogoseo_id.value = bogoseo_id;
       	document.listForm.action = "<c:url value='/alioBogoseo2.do'/>";
       	document.listForm.submit();
    }
    
    /* 글 등록 화면 function */
    function fn_egov_addView() {
       	document.listForm.action = "<c:url value='/addAlioSampleView.do'/>";
       	document.listForm.submit();
    }
...
<form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        <input type="hidden" name="bogoseo_id" />
        	...
        	<div id="table">
        		...
        		<table class="type10" width="100%">
					    ...
					    <tbody>
            				...
            				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.bogoseoId}"/>')"><c:out value="${result.title}"/></a></td>
            				<td align="center" class="listtd"><c:out value="${result.companyName}"/>&nbsp;</td>
